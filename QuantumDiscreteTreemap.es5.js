...
exports.QuantumDiscreteTreemap = void 0;
...
var Rectangle =
    ...
    function () {
        ...
        function Rectangle(arg1, arg2, arg3, arg4) {
            ...
            } else if (_instanceof(arg1, Rectangle)) {
...
System.arraycopy = function (source, sourceStartIndex, destination, destinationStartIndex, length) {
...
var Dimension = // class properties are still experimental
// width;
// height;
...
var QuantumDiscreteTreemap =
    ...
    function () {
         ...
         * @constructor
         */
        function QuantumDiscreteTreemap(sizes, iar, box) {
            this.EXPECTED_WASTE_FACTOR=1.15;

            var horizontalPadding = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
            var verticalPadding = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;

            _classCallCheck(this, QuantumDiscreteTreemap);
        ...
        _createClass(QuantumDiscreteTreemap, [{
            key: "computeAspectRatio",
            value: function computeAspectRatio(rect) {
            ...
            key: "computeSize",
            value: function computeSize(sizes) {
                var size = 0;
            ...
            key: "computeSize3",
            value: function computeSize3(sizes, i1, i2) {
                var size = 0;
            ...
            key: "_quantumLayout",
            value: function _quantumLayout(sizes, box, growWide) {
                var i;
                var l1 = null;
                var l2 = null;
                var l3 = null;
                ...
                boxAR = this.computeAspectRatio(box); // Stopping conditions

                if (sizes.length === 1) {
                    boxes = [];
                    boxes[0] = box;
                    // boxes[0] = new Rectangle(box.x, box.y, box.width + this.horizontalPadding, box.height + this.verticalPadding);
                    return boxes;
                }
                ...
                if (sizes.length === 2) {
                    ...
                    if (growWide) {
                        ...
                        dim2 = this.computeTableLayoutGivenHeight(sizes[1], h); // h needs to be recomputed due to padding
                        ...
                        dim2 = this.computeTableLayoutGivenWidth(sizes[1], w); // w needs to be recomputed due to padding
                ...
                for (i = pivotIndex + 1; i < sizes.length; i++) {
                    ...
                    pivotAR = Math.max(dim1.width / dim1.height, dim1.height / dim1.width);
            ...
            key: "computePivotIndex",
            value: function computePivotIndex(sizes) {
                var index = 0;
            ...
            key: "computeUnion",
            value: function computeUnion(boxes) {
                var x1, x2, y1, y2;
            ...
            key: "translateBoxesTo",
            value: function translateBoxesTo(boxes, x, y) {
            ...
            key: "evenBoxWidth2",
            value: function evenBoxWidth2() {
                var b1 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
                var b2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
            ...
            key: "evenBoxWidth3",
            value: function evenBoxWidth3(b1, b2, b3) {
                var dx = 0;
                var right;
                var newRight;
                ...
                newRight = Math.max(Math.max(b1Bounds.x + b1Bounds.width, b2Bounds.x + b2Bounds.width), b3Bounds.x + b3Bounds.width); // Then, fix up each region that is not the same width
            ...
            key: "evenBoxHeight3",
            value: function evenBoxHeight3(b1, b2, b3) {
                var dy = 0;
                var bottom;
                var newBottom;
                var b1Bounds, b2Bounds, b3Bounds; // Compute the actual bounds of the 3 regions
                ...
                newBottom = Math.max(Math.max(b1Bounds.y + b1Bounds.height, b2Bounds.y + b2Bounds.height), b3Bounds.y + b3Bounds.height); // Then, fix up each region that is not the same height
            ...
            key: "computeTableLayout",
            value: function computeTableLayout(numItems, ar) {
                var w, h;
            ...
            key: "computeTableLayoutGivenWidth",
            value: function computeTableLayoutGivenWidth(numItems, width) {
                var h;
            ...
            key: "computeTableLayoutGivenHeight",
            value: function computeTableLayoutGivenHeight(numItems, height) {
                var w;
        ...
        return QuantumDiscreteTreemap;
    }();

exports.QuantumDiscreteTreemap = QuantumDiscreteTreemap;